...
export default function ImagesTestPage() {
	return (
		<>
			...
			{/* Import poprzez URL, musimy określić width i height, domyślnie sizes jest ustawione na 1x, 2x, możemy manualnie dodać sizes="100vw",
            generowanie blura dla obrazka możemy dodać na serverze używając np. https://plaiceholder.co/docs */}
			<Image src="/baner_ekino.jpg" width={1920} height={874} alt="" />

            {/* Jeżeli nie znamy aspect-ratio to wtedy dodajemy atrybut fill,
            a do elementu nadrzędnego pozycję relatywną, oraz określamy height, natomiast musi to być element typu block */}
			<div className="relative h-[500px]">
				<Image
                    ...
                    // powyższy sizes pobiera nam obrazki o szerokości 1/4 ekranu od 1200px w górę (załóżmy że mamy grida na PC z 4 kolumnami)
                    // a poniżej, czyli załóżmy tablet / mobile, pobiera nam o szerokości równej ekranu.
                    // A właściwie to wybiera jedną ze zdefiniowanych rozdzielczości w pliku konfiguracyjnym
				/>
